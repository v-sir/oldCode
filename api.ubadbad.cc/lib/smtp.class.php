...
class MySendMail {
	...
	*/
	...
	public  function logging($error){
		...
		$DB=new DB("mail");
		$time=time();
		@$sql="insert into sendMail(create_at,operator,errMsg) values('$time','$this->operator','$error')";
	...
	*/
	protected function getMIMEType($file) {
		if(file_exists($file)) {
			//$mime = finfo_open($file);
			//if(! preg_match("/gif|jpg|png|jpeg/", $mime)){
				//$mime = "application/octet-stream";
			@$mime=image_type_to_mime_type($file);
			//}
			return $mime;
		}
		else {
